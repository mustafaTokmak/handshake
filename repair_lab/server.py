...
def create_server(port=8780, state_dir=Path('state'), host='127.0.0.1', store=None):
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            if path in ('/', '/app.js', '/flow.js', '/style.css'):
                name, mime = {'/': ('index.html', 'text/html; charset=utf-8'), '/app.js': ('app.js', 'text/javascript'), '/flow.js': ('flow.js', 'text/javascript'), '/style.css': ('style.css', 'text/css')}[path]
